...
// 35s cut — compressed version of Scene07Promesa (60f instead of 120f):
// same headline and wipe, much faster.
export const Scene07CompactPromesa: React.FC = () => {
  const frame = useCurrentFrame();

  const listOpacity = interpolate(frame, [18, 26], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  const wipe = interpolate(frame, [20, 50], [0, 100], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 44 }}>
        <div style={{ textAlign: "center" }}>
          <KineticWords
            text="Llegas con tu lista de pendientes."
            startFrame={0}
            fontSize={48}
            staggerFrames={3}
          />
