...
// 0:31 - 0:36 (150f) — First flow card: meeting to sent proposal.
export const Scene08Flujo1: React.FC = () => {
  ...
  const cardY = interpolate(frame, [0, 18], [30, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: Easing.bezier(0.16, 1, 0.3, 1),
  });

  const lineProgress = interpolate(frame, [12, 40], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: Easing.bezier(0.16, 1, 0.3, 1),
  });

  const cursorProgress = interpolate(frame, [24, 88], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  ...
  const clickBump = interpolate(frame, [88, 92, 98], [1, 1.3, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: Easing.bezier(0.16, 1, 0.3, 1),
      ...
      <div style={{ opacity: cardOpacity, translate: `0px ${cardY}px`, position: "relative" }}>
        <Card width={900} padding={56}>
          ...
          >
            ...
            <MorphNumber from="4 h" to="15 min" morphFrame={95} fontSize={40} />
          </div>
